          ...
          <BlurFade delay={BLUR_FADE_DELAY * 11}>
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <div className="text-3xl font-bold tracking-tighter sm:text-5xl inline-block rounded-lg bg-foreground text-background px-3 py-1">
                  My Projects
                </div>
        ...
        <div className="grid items-center justify-center gap-4 px-4 text-center md:px-6 w-full py-12">
          <BlurFade delay={BLUR_FADE_DELAY * 16}>
            <div className="space-y-3">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl inline-block rounded-lg bg-foreground text-background px-3 py-1">
                Contact
              </h2>
